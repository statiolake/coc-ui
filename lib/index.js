...
var CocUi = class {
  ...
  splitCommand(location) {
    const config = import_coc.workspace.getConfiguration("ui");
    if (location === "panel") {
  ...
  async ensureActivityBar(location) {
    ...
    if (!import_coc.workspace.getConfiguration("ui").get("activityBar.enable", true)) {
      return;
    }
    const surface = this.surface(location);
  ...
  async renderActivityBar(location) {
    ...
    const width = Math.max(
      2,
      import_coc.workspace.getConfiguration("ui").get("activityBar.width", 3)
    );
  ...
  async installViewKeymaps(viewId, containerId, windowId) {
    ...
    if (import_coc.workspace.getConfiguration("ui").get("mouse.enable", true)) {
...
async function activate(context) {
  ...
  context.subscriptions.push(
    ui,
    import_coc.commands.registerCommand("ui.showContainer", (id) => {
      return ui.showContainer(String(id));
    }),
    import_coc.commands.registerCommand("ui.showView", (id) => {
      return ui.showView(String(id));
    }),
    import_coc.commands.registerCommand("ui.closeContainer", (id) => {
      return ui.closeContainer(String(id));
    }),
    import_coc.commands.registerCommand("ui.closeLocation", (location) => {
      return ui.closeLocation(String(location));
    }),
    import_coc.commands.registerCommand("ui.showLocation", (location) => {
      return ui.showLocation(String(location));
    }),
    import_coc.commands.registerCommand("ui.hideLocation", (location) => {
      return ui.hideLocation(String(location));
    }),
    import_coc.commands.registerCommand("ui.toggleLocation", (location) => {
      return ui.toggleLocation(String(location));
    }),
    import_coc.commands.registerCommand("ui.togglePrimarySidebar", () => {
      return ui.toggleLocation("primarySidebar");
    }),
    import_coc.commands.registerCommand("ui.toggleSecondarySidebar", () => {
      return ui.toggleLocation("secondarySidebar");
    }),
    import_coc.commands.registerCommand("ui.togglePanel", () => {
      return ui.toggleLocation("panel");
    }),
    import_coc.commands.registerCommand("ui.toggleView", (id) => {
      return ui.toggleView(String(id));
    }),
    import_coc.commands.registerCommand("ui.toggleViewAtMouse", (id) => {
    ...
    import_coc.commands.registerCommand("ui.contextMenu", (id) => {
      return ui.showContextMenu(String(id));
    }),
    import_coc.commands.registerCommand("ui.routeRightMouse", () => {
      return ui.routeRightClick();
    }),
    import_coc.commands.registerCommand("ui.switchPrimarySidebar", () => {
      return ui.switchLocation("primarySidebar");
    }),
    import_coc.commands.registerCommand("ui.switchSecondarySidebar", () => {
