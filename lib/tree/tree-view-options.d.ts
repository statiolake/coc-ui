 ...
 */
export type PublicTreeViewOptions<T> = Omit<TreeViewOptions<T>, "disableLeafIndent">;
/**
 ...
 */
export declare function toNativeTreeViewOptions<T>(options: PublicTreeViewOptions<T>): TreeViewOptions<T>;
